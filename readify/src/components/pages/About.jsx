      ...
      className="max-w-4xl w-full space-y-16 text-center">
        ...
        <section>
          ...
          className="text-lg text-whiteleading-relaxed">
            ...
            <ul className="list-none list-inside mt-3 text-pink-300 font-bold">
              <li>React + Vite</li>
              <li>TailwindCSS</li>
              <li>React Router</li>
              <li>SweetAlert2</li>
        ...
        <section>
          ...
          className="text-lg text-white leading-relaxed">
            I'm a <span className="text-purple-400 font-semibold">Computer Science student</span> trying to pursue a career as a web developer.
            <br /><br />
